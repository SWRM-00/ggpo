...
public:
	Peer2PeerBackend(GGPOSessionCallbacks *cb,
...
protected:
	...
	virtual void OnUdpProtocolEvent(
	    NetworkProtocol::Event &e, GGPOPlayerHandle handle);
	virtual void OnUdpProtocolPeerEvent(NetworkProtocol::Event &e, int queue);
	virtual void OnUdpProtocolSpectatorEvent(
	    NetworkProtocol::Event &e, int queue);
